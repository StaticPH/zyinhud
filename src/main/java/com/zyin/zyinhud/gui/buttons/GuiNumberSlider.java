...
// */
//public class GuiNumberSlider extends Button {
//	/**
...
//	 * @param mode          the mode
//	 */
//	public GuiNumberSlider(
//		int id, int x, int y, int width, int height, String displayString, float minValue, float maxValue,
//		float currentValue, Modes mode
//	) {
...
//		if (mode == Modes.INTEGER) { return label + getValueAsInteger(); }
//		else if (mode == Modes.DECIMAL) { return label + twoDecimals.format(getValueAsFloat()); }
//		else if (mode == Modes.PERCENT) { return label + getValueAsPercent(); }
...
//			//experiment with https://github.com/Vazkii/AutoRegLib/blob/master/src/main/java/vazkii/arl/util/RenderHelper.java#L149
