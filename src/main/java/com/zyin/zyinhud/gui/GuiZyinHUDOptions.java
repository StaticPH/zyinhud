...
//    /**
//     * The constant zyinHudOptionsButton.
//     */
...
//
//    /**
//     * The constant rightClickableButtonsIDs.
//     */
...
//
//            int x = tabbedButtonWidth + tabbedButtonX + buttonSpacing * 2 + buttonWidth + buttonSpacing * 2 + buttonWidth / 2 - mc.fontRenderer.getStringWidth(text) / 2;
...
//        Button prevPageButton = new Button(10, tabbedButtonX, tabbedButtonY - pagingButtonHeight, pagingButtonWidth, pagingButtonHeight, "<");
//        Button nextPageButton = new Button(11, tabbedButtonX + tabbedButtonWidth - pagingButtonWidth + 1, tabbedButtonY - pagingButtonHeight, pagingButtonWidth, pagingButtonHeight, ">");
//
//        if (tabbedPage == 0)
...
//
//            buttons.add(new GuiLabeledButton(id, tabbedButtonX, Y, tabbedButtonWidth, tabbedButtonHeight, buttonName, buttonLabel));
//
...
//        AddButtonAt(0, 1, new Button(2002, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("miscellaneous.options.usequickplacesign", Miscellaneous.UseQuickPlaceSign)));
//        AddButtonAt(0, 2, new Button(2003, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("miscellaneous.options.useunlimitedsprinting", Miscellaneous.UseUnlimitedSprinting)));
//        AddButtonAt(0, 3, new Button(2004, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("miscellaneous.options.showanvilrepairs", Miscellaneous.ShowAnvilRepairs)));
//
//    }
//
...
//        AddButtonAt(0, 1, new Button(102, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("infoline.options.showbiome", InfoLine.ShowBiome)));
//        AddButtonAt(0, 2, new Button(105, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("infoline.options.showcansnow", InfoLine.ShowCanSnow)));
//        AddButtonAt(0, 3, new Button(106, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("infoline.options.showping", InfoLine.ShowPing)));
...
//        AddButtonAt(0, 1, new Button(202, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Mode(Clock.Mode.GetFriendlyName())));
//
//    }
//
//    private void DrawCoordinatesButtons() {
//        AddButtonAt(0, 0, new Button(301, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(Coordinates.Enabled)));
//        AddButtonAt(0, 1, new GuiHotkeyButton(303, 0, 0, buttonWidth, buttonHeight, CoordinatesKeyHandler.HotkeyDescription));
//        AddButtonAt(0, 2, new Button(304, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Mode(Coordinates.Mode.GetFriendlyName())));
//        AddButtonAt(0, 3, new Button(302, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("coordinates.options.useycoordinatecolors", Coordinates.UseYCoordinateColors)));
//        AddButtonAt(0, 4, new Button(305, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("coordinates.options.showchunkcoordinates", Coordinates.ShowChunkCoordinates)));
//
//    }
//
...
//        AddButtonAt(0, 0, new Button(601, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(DistanceMeasurer.Enabled)));
...
//        AddButtonAt(0, 0, new Button(701, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(SafeOverlay.Enabled)));
...
//        AddButtonAt(0, 4, new Button(705, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("safeoverlay.options.displayinnether", SafeOverlay.instance.GetDisplayInNether())));
//        AddButtonAt(0, 5, new Button(706, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("safeoverlay.options.seethroughwalls", SafeOverlay.instance.GetSeeUnsafePositionsThroughWalls())));
//
//    }
//
//    private void DrawPlayerLocatorButtons() {
//        AddButtonAt(0, 0, new Button(801, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(PlayerLocator.Enabled)));
...
//        AddButtonAt(0, 3, new Button(804, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("playerlocator.options.showdistancetoplayers", PlayerLocator.ShowDistanceToPlayers)));
//        AddButtonAt(0, 4, new Button(805, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("playerlocator.options.showplayerhealth", PlayerLocator.ShowPlayerHealth)));
//
//        AddButtonAt(1, 0, new Button(808, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("playerlocator.options.showwitherskeletons", PlayerLocator.ShowWitherSkeletons)));
//        AddButtonAt(1, 1, new Button(806, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("playerlocator.options.showwolves", PlayerLocator.ShowWolves)));
//        AddButtonAt(1, 2, new Button(807, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("playerlocator.options.usewolfcolors", PlayerLocator.UseWolfColors)));
//
//    }
//
...
//        AddButtonAt(0, 3, new Button(907, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("animalinfo.options.showtextbackground", AnimalInfo.ShowTextBackgrounds)));
...
//        AddButtonAt(0, 5, new Button(905, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("animalinfo.options.showhorsestatsonf3menu", AnimalInfo.ShowHorseStatsOnF3Menu)));
//        AddButtonAt(0, 6, new Button(906, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("animalinfo.options.showhorsestatsoverlay", AnimalInfo.ShowHorseStatsOverlay)));
//
//        AddButtonAt(1, 0, new Button(916, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("animalinfo.options.showbreedingicons", AnimalInfo.ShowBreedingIcons)));
...
//        AddButtonAt(0, 0, new Button(1001, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(PotionTimers.Enabled)));
//        AddButtonAt(0, 1, new Button(1005, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_String("potiontimers.options.textmode", PotionTimers.TextMode.GetFriendlyName())));
//        AddButtonAt(0, 2, new Button(1002, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.showpotionicons", PotionTimers.ShowPotionIcons)));
//        AddButtonAt(0, 3, new Button(1007, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.hidepotioneffectsininventory", PotionTimers.HidePotionEffectsInInventory)));
//        AddButtonAt(0, 4, new Button(1008, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.hidebeaconpotioneffects", PotionTimers.HideBeaconPotionEffects)));
...
//        AddButtonAt(1, 0, new Button(1009, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.showvanillastatuseffecthud", PotionTimers.ShowVanillaStatusEffectHUD)));
//        AddButtonAt(1, 1, new Button(1010, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.showeffectname", PotionTimers.ShowEffectName)));
//        AddButtonAt(1, 2, new Button(1011, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("potiontimers.options.showeffectlevel", PotionTimers.ShowEffectLevel)));
//    }
//
//    private void DrawDurabilityInfoButtons() {
//        AddButtonAt(0, 0, new Button(1101, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(DurabilityInfo.Enabled)));
//        AddButtonAt(0, 1, new Button(1102, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.showarmordurability", DurabilityInfo.ShowArmorDurability)));
...
//        AddButtonAt(0, 3, new Button(1111, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.autounequiparmor", DurabilityInfo.AutoUnequipArmor)));
//        AddButtonAt(0, 4, new Button(1104, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.showindividualarmoricons", DurabilityInfo.ShowIndividualArmorIcons)));
...
//
//        AddButtonAt(1, 0, new Button(1113, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.usecolorednumbers", DurabilityInfo.UseColoredNumbers)));
//        AddButtonAt(1, 1, new Button(1105, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.showitemdurability", DurabilityInfo.ShowItemDurability)));
...
//        AddButtonAt(1, 3, new Button(1112, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.autounequiptools", DurabilityInfo.AutoUnequipTools)));
//        AddButtonAt(1, 4, new Button(1110, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_String("durabilityinfo.options.textmode", DurabilityInfo.TextMode.GetFriendlyName())));
//        AddButtonAt(1, 5, new Button(1118, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("durabilityinfo.options.hidedurabilityinfoinchat", DurabilityInfo.HideDurabilityInfoInChat)));
//    }
//
//    private void DrawEnderPearlAidButtons() {
//        AddButtonAt(0, 0, new Button(1201, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(EnderPearlAid.Enabled)));
...
//        AddButtonAt(0, 0, new Button(1501, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(WeaponSwapper.Enabled)));
...
//        AddButtonAt(0, 0, new Button(1601, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(QuickDeposit.Enabled)));
//        AddButtonAt(0, 1, new GuiHotkeyButton(1602, 0, 0, buttonWidth, buttonHeight, QuickDepositKeyHandler.HotkeyDescription));
//        AddButtonAt(0, 2, new Button(1603, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.ignoreitemsinhotbar", QuickDeposit.IgnoreItemsInHotbar)));
//        AddButtonAt(0, 3, new Button(1604, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.closechestafterdepositing", QuickDeposit.CloseChestAfterDepositing)));
//
//        AddButtonAt(1, 0, new Button(1605, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklisttorch", QuickDeposit.BlacklistTorch)));
//        AddButtonAt(1, 1, new Button(1612, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklisttools", QuickDeposit.BlacklistTools)));
//        AddButtonAt(1, 2, new Button(1611, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistweapons", QuickDeposit.BlacklistWeapons)));
//        AddButtonAt(1, 3, new Button(1606, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistarrow", QuickDeposit.BlacklistArrow)));
//        AddButtonAt(1, 4, new Button(1607, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistfood", QuickDeposit.BlacklistFood)));
//        AddButtonAt(1, 5, new Button(1608, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistenderpearl", QuickDeposit.BlacklistEnderPearl)));
//        AddButtonAt(1, 6, new Button(1609, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistwaterbucket", QuickDeposit.BlacklistWaterBucket)));
//        AddButtonAt(1, 7, new Button(1610, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("quickdeposit.options.blacklistclockcompass", QuickDeposit.BlacklistClockCompass)));
//
//    }
//
//    private void DrawItemSelectorButtons() {
//        AddButtonAt(0, 0, new Button(1701, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(ItemSelector.Enabled)));
//        AddButtonAt(0, 1, new GuiHotkeyButton(1702, 0, 0, buttonWidth, buttonHeight, ItemSelectorKeyHandler.HotkeyDescription));
//        AddButtonAt(0, 2, new Button(1704, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Mode(ItemSelector.Mode.GetFriendlyName())));
...
//        AddButtonAt(0, 4, new Button(1705, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("itemselector.options.sideButtons", ItemSelector.UseMouseSideButtons)));
//
//    }
//
//    private void DrawHealthMonitorButtoins() {
//        AddButtonAt(0, 0, new Button(1801, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Enabled(HealthMonitor.Enabled)));
//        AddButtonAt(0, 1, new Button(1802, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Mode(HealthMonitor.Mode.GetFriendlyName())));
//        AddButtonAt(0, 2, new Button(1804, 0, 0, buttonWidth, buttonHeight, GetButtonLabel_Boolean("healthmonitor.options.playfasterneardeath", HealthMonitor.PlayFasterNearDeath)));
...
//
//        AddButtonAt(1, 1, new Button(1803, 0, 0, buttonWidth / 2, buttonHeight, Localization.get("healthmonitor.options.mode.play")));
...
//        return currentlySelectedTabButton != null && currentlySelectedTabButton.displayString.replace(currentlySelectedTabButtonColor, "").equals(buttonTabLabel);
//    }
//
//    /**
